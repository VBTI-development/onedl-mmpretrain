...
1. Fork and pull the latest MMPreTrain repository, follow [get started](https://onedl-mmpretrain.readthedocs.io/en/latest/get_started.html) to setup the environment.
