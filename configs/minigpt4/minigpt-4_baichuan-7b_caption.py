...
model = dict(
    ...
    vision_encoder=dict(
        ...
        out_type='raw',
        pretrained=  # noqa
        'https://mmassets.onedl.ai/mmpretrain/v1.0/minigpt4/minigpt-4_eva-g-p14_20230615-e908c021.pth'  # noqa
    ),
    q_former_model=dict(
        type='Qformer',
        ...
        num_query_token=32,
        pretrained=  # noqa
        'https://mmassets.onedl.ai/mmpretrain/v1.0/minigpt4/minigpt-4_qformer_20230615-1dfa889c.pth'  # noqa
    ),
    lang_encoder=dict(
