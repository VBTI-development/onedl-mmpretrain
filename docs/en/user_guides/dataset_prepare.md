...
We have provided a sample, which you can download and extract from this [link](https://mmassets.onedl.ai/mmpretrain/datasets/imagenet_1k.zip). The directory structure of the dataset should be as below:
...
You can download and untar the meta data from this [link](https://mmassets.onedl.ai/mmclassification/datasets/imagenet/meta/caffe_ilsvrc12.tar.gz). And re-organize the dataset as below:
