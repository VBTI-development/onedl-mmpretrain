...
Usually, we use python files as config file. All configuration files are placed under the [`configs`](https://github.com/VBTI-development/onedl-mmpretrain/tree/main/configs) folder, and the directory structure is as follows:
...
This article mainly explains the structure of configuration files, and how to modify it based on the existing configuration files. We will take [ResNet50 config file](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/resnet/resnet50_8xb32_in1k.py) as an example and explain it line by line.

## Config Structure

There are four kinds of basic component files in the `configs/_base_` folders, namely：

- [models](https://github.com/VBTI-development/onedl-mmpretrain/tree/main/configs/_base_/models)
- [datasets](https://github.com/VBTI-development/onedl-mmpretrain/tree/main/configs/_base_/datasets)
- [schedules](https://github.com/VBTI-development/onedl-mmpretrain/tree/main/configs/_base_/schedules)
- [runtime](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/_base_/default_runtime.py)
...
For easy understanding, we use [ResNet50 config file](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/resnet/resnet50_8xb32_in1k.py) as an example and comment on each line.
...
Following is the model primitive config of the ResNet50 config file in [`configs/_base_/models/resnet50.py`](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/_base_/models/resnet50.py):
...
model = dict(
    ...
    backbone=dict(
        ...
        # and you can find them from https://onedl-mmpretrain.readthedocs.io/en/latest/api/generated/mmpretrain.models.backbones.ResNet.html
        depth=50,
        num_stages=4,
        out_indices=(3, ),
        frozen_stages=-1,
    ...
    head=dict(
        ...
        # and you can find them from https://onedl-mmpretrain.readthedocs.io/en/latest/api/generated/mmpretrain.models.heads.LinearClsHead.html
        num_classes=1000,
        in_channels=2048,
...
- `train_dataloader | val_dataloader | test_dataloader`: The settings of dataloaders
  ...
  - `dataset`: The settings of the dataset.
    ...
    - `pipeline`: The data transform pipeline. You can find how to design a pipeline in [this tutorial](https://onedl-mmpretrain.readthedocs.io/en/latest/tutorials/data_pipeline.html).

Following is the data primitive config of the ResNet50 config in [`configs/_base_/datasets/imagenet_bs32.py`](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/_base_/datasets/imagenet_bs32.py)：
...
Following is the schedule primitive config of the ResNet50 config in [`configs/_base_/datasets/imagenet_bs32.py`](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/_base_/datasets/imagenet_bs32.py)：
...
Here is the runtime primitive config file ['configs/_base_/default_runtime.py'](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/_base_/default_runtime.py) file used by almost all configs:
...
The following is an example of using auto augment in the training data preprocessing pipeline, refer to [`configs/resnest/resnest50_32xb64_in1k.py`](https://github.com/VBTI-development/onedl-mmpretrain/blob/main/configs/resnest/resnest50_32xb64_in1k.py). When defining `train_pipeline`, just add the definition file name of auto augment to `_base_`, and then use `_base_.auto_increasing_policies` to reference the variables in the primitive config:
