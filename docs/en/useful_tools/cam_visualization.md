...
3. Use `--eigen-smooth` and `--aug-smooth` to improve visual effects.
   ...
   python tools/visualization/vis_cam.py \
       ...
       https://mmassets.onedl.ai/mmclassification/v0/mobilenet_v3/convert/mobilenet_v3_large-3ea3c186.pth \
...
1. Visualize CAM for `Swin Transformer`, using default `target-layers`:
   ...
   python tools/visualization/vis_cam.py \
       ...
       https://mmassets.onedl.ai/mmclassification/v0/swin-transformer/swin_tiny_224_b16x64_300e_imagenet_20210616_090925-66df6be6.pth \
       --vit-like
   ```
...
2. Visualize CAM for `Vision Transformer(ViT)`:
   ...
   python tools/visualization/vis_cam.py \
       ...
       https://mmassets.onedl.ai/mmclassification/v0/vit/finetune/vit-base-p16_in21k-pre-3rdparty_ft-64xb64_in1k-384_20210928-98e8652b.pth \
       --vit-like \
...
3. Visualize CAM for `T2T-ViT`:
   ...
   python tools/visualization/vis_cam.py \
       ...
       https://mmassets.onedl.ai/mmclassification/v0/t2t-vit/t2t-vit-t-14_3rdparty_8xb64_in1k_20210928-b7c09b62.pth \
       --vit-like \
